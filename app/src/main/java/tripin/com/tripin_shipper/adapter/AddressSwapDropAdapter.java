 ...
 */
public class AddressSwapDropAdapter extends RecyclerView.Adapter<AddressSwapDropAdapter.ItemViewHolder>
    ...
    public AddressSwapDropAdapter(Context context, OnStartDragListener dragStartListener, ArrayList<AddressObj> nameList) {
